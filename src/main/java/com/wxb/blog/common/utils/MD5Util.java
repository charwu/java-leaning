...
public class MD5Util {
	...
	public static final String AUTH_KEY = "inFo@TaobaO-coM";
	...
	/** * 生成MD5字符串 字符串后面追加日期 */
	public static String getMD5WithDateString( String value ) {
		if (null == value) {
			return null;
		}
		value = getMD5String(value);
		long current = System.currentTimeMillis();
		value = value + "_" + current;
		return value;
	}
}
